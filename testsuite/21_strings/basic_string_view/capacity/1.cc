...
template 
  const std::basic_string_view<A<B>>::size_type 
  std::basic_string_view<A<B>>::_Rep::_S_max_size;

template 
  const A<B>
  std::basic_string_view<A<B>>::_Rep::_S_terminal;
#endif
