...
// /home/ed/bin/bin/g++ -g -std=c++14 -fdiagnostics-color=always -o test_filesystem_std test_filesystem_std.cpp /home/ed/bin/lib64/libstdc++fs.a

// LD_LIBRARY_PATH=/home/ed/bin/lib64:$LD_LIBRARY_PATH ./test_filesystem_std

// LD_LIBRARY_PATH=/home/ed/bin/lib64:$LD_LIBRARY_PATH ./test_filesystem_std > test_std.txt 2> test_std.err

// LD_LIBRARY_PATH=/home/ed/bin/lib64:$LD_LIBRARY_PATH ./test_filesystem_std > test_std.new.txt 2> test_std.new.err

// LD_LIBRARY_PATH=/home/ed/bin/lib64:$LD_LIBRARY_PATH ./test_filesystem_std > test_std.new2.txt 2> test_std.new2.err
...
main()
{
  ...
  std::ofstream ofwbbb(wbbb);
  ofwbbb << "Primus Sucks!!!\n";

  std::ifstream ifwbbb(wbbb);
  std::string line;
