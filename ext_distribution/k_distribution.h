#ifndef __K_DISTRIBUTION
#define __K_DISTRIBUTION 1
...
namespace __gnu_cxx
{
  ...
  template<typename _RealType = double>
	...
	result_type _M_nu;
       ...
       */
      explicit
      k_distribution(result_type __lambda = result_type(1),
		     result_type __mu = result_type(1),
		     result_type __nu = result_type(1))
...
#endif // __K_DISTRIBUTION

#ifndef __K_DISTRIBUTION_TCC
#define __K_DISTRIBUTION_TCC 1
