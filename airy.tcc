 ...
 */
        ...
        std::complex<_Tp> & zi2d3, std::complex<_Tp> & zim2d3)
  {
    ...
    zd2pow = std::pow(dhalf * dcmplx(dzr, dzi), -d1d3);
...
template<typename _Tp>
         ...
         std::complex<_Tp> & zai, std::complex<_Tp> & zaipr)
  {
    ...
    dcmplx zout, zoutpr, zpw1d4, zxim, zmone;
    _Tp dx, dy, dr, ds, dal, dbe, dalpr, dbepr, dsdata;
    int nterm, ndx;
...
template<typename _Tp>
         ...
         std::complex<_Tp> & zai, std::complex<_Tp> & zaipr)
  {
    ...
    dcmplx zwk, zsinxi, zcosxi, zpw1d4, zxi, zone;
