...
template<typename _Tp>
  ...
  cyl_hankel_h1(std::complex<_Tp> __nu, std::complex<_Tp> __z)
  {
    ...
    int __error;
    __hankel(__nu, __z, __h1, __h1p, __h2, __h2p, __error);
    return __h1;
  }
...
template<typename _Tp>
  ...
  sph_hankel_h1(int __n, std::complex<_Tp> __z)
  {
    ...
    int __error;
    __hankel(__nu, __z, __h1, __h1p, __h2, __h2p, __error);
    return std::sqrt(__pi / (_Tp(2) * __z)) * __h1;
  }
...
//    int __error;
//    __airy(__z, __ai, __aip, __bi, __bip, __error);
//    return __bi;
//  }
