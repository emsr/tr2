...
// $HOME/bin/bin/g++ -std=c++11 -o uniform_container_erasure_std uniform_container_erasure_std.cpp

// $HOME/bin/bin/g++ -std=c++14 -o uniform_container_erasure_std uniform_container_erasure_std.cpp

// LD_LIBRARY_PATH=$HOME/bin/lib64:$LD_LIBRARY_PATH ./uniform_container_erasure_std > ./uniform_container_erasure_std.out
